...
function ensureAudibleSeedData(){
  ...
  if(hasTable('release_metadata'))db.run(`INSERT OR REPLACE INTO release_metadata(version,release_date,build_id,schema_version,title,created_at) VALUES ('1.4.17.24','2026-08-08','141724',147,'Audible Dynamic Cover Cache','2026-08-08T14:45:00-04:00')`);
}
