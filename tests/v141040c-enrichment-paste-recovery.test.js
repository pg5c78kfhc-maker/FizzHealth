...
test('v1.4.10.40c remains recorded in release history',()=>{
 const release=history.releases.find(item=>item.version==='1.4.10.40c');
 assert.ok(release);
 assert.equal(release.build,'141040C');
 assert.match(main,/version:'1\.4\.10\.40c'/);
});
