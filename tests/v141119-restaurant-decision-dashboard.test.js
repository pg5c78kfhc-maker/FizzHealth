...
test('release metadata identifies restaurant decision dashboard',()=>{assert.equal(meta.version,'1.4.11.20');assert.equal(meta.build,'141320')});
...
test('price stays in a prominent pill above rank',()=>{assert.match(main,/restaurant-card-toolbar/);assert.match(css,/restaurant-price-badge\{display:grid/)});
