...
test('program cards expose edit and nested workout management actions',()=>{assert.match(main,/Add historical workout to/);assert.match(main,/nested-workout-list/);assert.match(main,/Add historical workout to/)});
test('workouts can be created and edited per program',()=>{assert.match(main,/INSERT INTO program_workouts/);assert.match(main,/UPDATE program_workouts/);assert.match(main,/New Workout/)});
