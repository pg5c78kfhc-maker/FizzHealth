...
test('release metadata advances to v1.4.11.22',()=>{assert.equal(meta.version,'1.4.11.22');assert.equal(meta.build,'141122');assert.match(main,/const VERSION='1\.4\.11\.22'/)});
