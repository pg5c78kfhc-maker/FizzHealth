...
test('v1.4.11.2 corrective metadata is canonical',()=>{assert.equal(meta.version,'1.4.11.23');assert.equal(meta.build,'141123');assert.match(main,/const VERSION='1\.4\.11\.23'/)});
