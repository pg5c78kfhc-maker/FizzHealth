...
test('release metadata advances to v1.4.10.42a',()=>{assert.equal(meta.version,'1.4.10.42a');assert.equal(meta.build,'141042A');assert.match(main,/const VERSION='1\.4\.10\.42a'/);});
