...
test('release metadata advances to v1.4.10.42b',()=>{assert.equal(meta.version,'1.4.10.42b');assert.equal(meta.build,'141042B');assert.match(main,/const VERSION='1\.4\.10\.42b'/);});
