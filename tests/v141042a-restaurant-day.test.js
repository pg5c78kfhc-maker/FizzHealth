...
test('release metadata advances to v1.4.10.43a',()=>{assert.equal(meta.version,'1.4.11.17');assert.equal(meta.build,'141317');assert.match(main,/const VERSION='1\.4\.11\.17'/);});
