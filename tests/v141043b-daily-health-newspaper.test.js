...
test('43b metadata identifies Daily Health Newspaper',()=>{assert.equal(meta.version,'1.4.11.0');assert.equal(meta.build,'141100');assert.match(main,/const VERSION='1\.4\.11\.0'/)});
