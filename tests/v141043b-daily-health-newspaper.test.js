...
test('43b metadata identifies Daily Health Newspaper',()=>{assert.equal(meta.version,'1.4.11.18');assert.equal(meta.build,'141318');assert.match(main,/const VERSION='1\.4\.11\.18'/)});
