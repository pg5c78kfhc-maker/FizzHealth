...
test('43b metadata identifies Daily Health Newspaper',()=>{assert.equal(meta.version,'1.4.10.43b');assert.equal(meta.build,'141043B');assert.match(main,/const VERSION='1\.4\.10\.43b'/)});
