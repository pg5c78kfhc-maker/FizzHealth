...
test('43b metadata identifies Daily Health Newspaper',()=>{assert.equal(meta.version,'1.4.11.7');assert.equal(meta.build,'141170');assert.match(main,/const VERSION='1\.4\.11\.7'/)});
