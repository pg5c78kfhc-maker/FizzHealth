...
test('current schema target includes provenance and trans fat support',()=>{assert.match(db,/TARGET_SCHEMA_VERSION=53/);assert.match(db,/complete_nutrient_contract_and_provenance/);assert.match(db,/ALTER TABLE foods ADD COLUMN trans_fat/)});
