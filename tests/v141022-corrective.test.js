...
test('v1.4.10.36 release identity is canonical',()=>{
 assert.equal(pkg.version,'1.4.10.36');
 assert.match(main,/const VERSION='1\.4\.10\.36'/);
 assert.match(main,/const BUILD_ID='141036'/);
});
