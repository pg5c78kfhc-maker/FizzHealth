...
test('v1.4.10.32 release identity is canonical',()=>{
 assert.equal(pkg.version,'1.4.10.32');
 assert.match(main,/const VERSION='1\.4\.10\.32'/);
 assert.match(main,/const BUILD_ID='141032'/);
});
