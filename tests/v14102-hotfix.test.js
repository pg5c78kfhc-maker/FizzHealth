...
test('v1.4.10.7 release and navigation',()=>{assert.match(main,/VERSION='1\.4\.10\.7'/);assert.doesNotMatch(main,/id:'add',I:Plus,label:'Add'/);assert.match(main,/className="universal-fab"/)});
