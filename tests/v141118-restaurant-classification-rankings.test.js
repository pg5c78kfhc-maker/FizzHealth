...
test('release metadata identifies restaurant classification release',()=>{assert.equal(meta.version,'1.4.11.21');assert.equal(meta.schema_version,54);assert.equal(meta.build,'141121')});
