...
test('first-class meal model and categories are present',()=>{assert.match(db,/CREATE TABLE IF NOT EXISTS meal_definitions/);assert.match(db,/CREATE TABLE IF NOT EXISTS meal_components/);assert.match(main,/Breakfast','Lunch','Dinner','Snack','Any/)});
