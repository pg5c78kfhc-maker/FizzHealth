...
test('v1.4.13.7 uses collapsible planned, Chef, category, and restaurant sections',()=>{
 assert.match(main,/openSections/);assert.match(main,/planned:\$\{slot\}/);assert.match(main,/Chef Recommendations/);assert.match(main,/categoryNames/);assert.match(main,/restaurantGroups/);
});
